...
namespace WpfKb.Controls
{
    ...
    public class OnScreenKey : Border
    {
        ...
        public static readonly DependencyProperty KeyBackgroundProperty = DependencyProperty.Register("KeyBackground", typeof(String), typeof(OnScreenKey));
        ...
        {
            get { return (String)GetValue(KeyBackgroundProperty); }
            set { SetValue(KeyBackgroundProperty, value.ToString()); }
        }
