            ...
            Keys = new ObservableCollection<OnScreenKey>
                       {
                           ...
                           new OnScreenKey { KeyBackground = "Red", GridRow = 3, GridColumn = 0, Key = new VirtualKey(VirtualKeyCode.BACK, "Del") },
                           new OnScreenKey { GridRow = 3, GridColumn = 1, Key = new VirtualKey(VirtualKeyCode.VK_0, "0") },
                           new OnScreenKey { KeyBackground = "Red", GridRow = 3, GridColumn = 2, Key = new VirtualKey(VirtualKeyCode.DELETE, "Canc") },
                       };
        }
    }
}